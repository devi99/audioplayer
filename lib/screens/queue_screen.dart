                          ...
                          child: Row(
                            children: [
                              ...
                              if (!isCurrent)
                                IconButton(
                                  onPressed: () async {
                                    debugPrint('[QueueScreen] Play button pressed for item ${item.id} at index $index');
                                    await _queueManager.playItem(item);
                                  },
                              ...
                              IconButton(
                                onPressed: () async {
                                  debugPrint('[QueueScreen] Delete button pressed for item ${item.id}');
